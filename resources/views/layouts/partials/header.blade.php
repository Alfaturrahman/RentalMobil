        ...
        <div class="header__content">
          <div class="header__logo">
            <a href="{{ route('home.index') }}">
              <img src="{{ asset('img/rentallogo.png') }}" alt="" style="width: 150px; height: auto;">
            </a>
          </div>
          ...
          <div class="header__actions">
            ...
            <div class="header__action">
              <a class="header__action-btn" href="{{ route('car.index') }}">
                <span>Jelajahi Rental mobil kami</span>
